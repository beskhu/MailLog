...
class Message
{
     ...
     * @var string
     */
    public static $charsetFlag = '//IGNORE';
    ...
    protected function processStructure($structure, $partIdentifier = null)
    {
        ...
        if ((isset($parameters['name']) || isset($parameters['filename']))
            ...
            if (array_key_exists('charset', $parameters) && !empty($parameters['charset'])) {
            	...
            	$messageBodyConv = @iconv(strtoupper(mb_detect_encoding($messageBody)), self::$charset . self::$charsetFlag, $messageBody);
