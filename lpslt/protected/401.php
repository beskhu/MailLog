...
<head>
	<title>Api Fetching Mail - 401</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="subwrapper" style="height:100%;">
			<div class="content">
				<div id="blank"></div>
				<div style="text-align:center; color:#000;" id="polysoft_container" class="polysoft_resizable">
					<span style="font-size:10em;">
						&nbsp;&nbsp;401&nbsp;&nbsp;
					</span>
					<br />
					<span style="font-size:1.5em; font-weight:bold;"><?php echo $_SESSION['locales']['refused401'][$_SESSION['current-language']].'<br />'.$_SESSION['locales']['redirectedShortly'][$_SESSION['current-language']]; ?></span><br />
					<script type="text/javascript">setTimeout(function() { window.location=window.location.href.replace(/[^\/]+$/, "")+"index"; }, 5000);</script>
					<br />
					<br />
				</div>
			</div>
	...
	<div id="polysoft_searchResults" style="display:none; width:auto; height:auto; position:fixed; z-index:10001;">
		<div id="polysoft_searchResultsCont" style="width:18em;">
			<div id="polysoft_bubble_top" style="width:100%; height:0px; position:relative; text-align:left;"><img src="lpslt/media/bubble_top.png" style="border:none; width:100%; height:100%;"/></div><div id="polysoft_bubble_middle" style="top:-1px; width:100%; height:0px; position:relative; text-align:left;"><img src="lpslt/media/bubble_middle.png" style="border:none; width:100%; height:100%; position:absolute; left:0%;"/><span id="polysoft_bubble_content" style="display:block; width:100%; height:100%; position:relative; top:0em; opacity:0;"></span></div><div id="polysoft_bubble_bottom" style="top:-1px; width:100%; height:0px; position:relative; text-align:left;"><img src="lpslt/media/bubble_bottom.png" style="border:none; width:100%; height:100%; position:absolute;"/></div>
		</div>
	</div>
</body>
</html>